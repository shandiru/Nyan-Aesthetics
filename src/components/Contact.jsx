      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-sage max-w-2xl mx-auto leading-relaxed">
            Ready to transform your appearance? Contact Nyan Aesthetics today to book your consultation
          </p>
        </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 p-3 rounded-lg bg-[#F3F1EF]">
                  ...
                  <div>
                    ...
                    <a href="tel:+447423294552" className="text-[#666] hover:text-[#222] transition-colors">+44 7423 294552</a>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-3 rounded-lg bg-[#F3F1EF]">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@nyanaesthetics.co.uk" className="text-[#666] hover:text-[#222] transition-colors">info@nyanaesthetics.co.uk</a>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-3 rounded-lg bg-[#F3F1EF]">
                  ...
                  <div>
                    ...
                    <p className="text-[#666]">16-20 Regent St, Leeds LS2 7QA, United Kingdom</p>
                  </div>
                </div>
            ...
            <div className="rounded-xl border border-[#EAEAEA] overflow-hidden shadow-sm">
              <div className="relative h-52">
                <img
                  ...
                  alt="Beauty by Jita salon interior"
