        ...
        <div className="max-w-4xl mt-15 mx-auto text-center">
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 mb-8">
            <h1 className="text-4xl lg:text-6xl font-bold text-balance mb-6 text-[#222222]">
              Advanced Aesthetic & Skin Treatments
            ...
            <p className="text-lg md:text-xl text-sage mb-8 max-w-2xl mx-auto leading-relaxed">
              Nyan Aesthetics provides advanced aesthetic treatments with expert practitioners and cutting-edge technology.
              Enjoy professional care in our clinical environment in Leeds with exceptional results.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 text-center">
            {[
              ...
              { number: "100%", label: "Professional Care" },
            ].map((stat, i) => (
              <div
                key={i}
