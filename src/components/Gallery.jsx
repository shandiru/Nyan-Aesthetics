...
const galleryItems = [
  {
    ...
    title: "Plasma Hair Treatment",
    desc: "Advanced plasma therapy for hair restoration and smooth, healthy hair.",
    image: "/n1.webp",
  },
  {
    id: 2,
    category: "Alopecia Treatment",
    title: "Alopecia Treatment",
    desc: "Specialized treatment that completely clears alopecia with gentle care.",
    image: "/n2.webp",
  },
  {
    id: 3,
    ...
    desc: "Cutting-edge laser technology for precise skin improvements and rejuvenation.",
    image: "/n3.webp",
  },
];
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-sage max-w-2xl mx-auto leading-relaxed">
            Explore our top plasma, alopecia, and laser treatment results with real service examples.
          </p>
        </div>
